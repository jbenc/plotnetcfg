...
OBJECTS=args ethtool frontend handler if label main match netlink netns \
        tunnel utils sysfs master addr
HANDLERS=bridge openvswitch veth vlan iov bond team vxlan
FRONTENDS=dot json
