...
plotnetcfg: args.o dot.o ethtool.o handler.o if.o label.o main.o netns.o tunnel.o utils.o \
	    parson/parson.o \
...
handlers/openvswitch.o: handlers/openvswitch.h parson/parson.h args.h handler.h label.h tunnel.h utils.h
